                            ...
                            <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <input name="guru_id[]" id= "guru_id" value="{{ $jadwal ->guru_id}}" readonly \>
                                            ...
                                            <td>
                                                <select class="custom-select" name="kehadiran[]"required>
                                                <option selected disabled value="">KEHADIRAN</option>
